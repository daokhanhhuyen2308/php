    ...
    <div class="content">
      ...
      <div class="card">
        ...
        <div class="card_container">
          ...
          <p>
            Giá: <?php echo $giatien?><br>
            Khuyến mại: <?php echo $khuyenmai?>
          </p>
          <!-- <a href="addtocart.php?id=<?php echo $masp; ?>" style=" color:pink">Addtocart</a> -->
          <div>
            <button><a href="update_sp.php?id=<?php echo $masp; ?>" style=" color:black">Sửa</a></button>
            <button><a href="delete_sp.php?id=<?php echo $masp; ?>" style=" color:black">Xoá</a></button>
          </div>
        </div>
      </div> <?php
            }
